...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('2022.06.31', '#timer');
...
/* harmony import */ var _services_inputValidationNumber__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/inputValidationNumber */ "./src/js/modules/services/inputValidationNumber.js");
        ...
        switch (item.tagName) {
          ...
          case 'INPUT':
            if (item.type === 'checkbox') {
              ...
              Object(_services_inputValidationNumber__WEBPACK_IMPORTED_MODULE_1__["default"])(item);
...
/* harmony import */ var _services_inputValidationNumber__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/inputValidationNumber */ "./src/js/modules/services/inputValidationNumber.js");
/* harmony import */ var _services_postData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/postData */ "./src/js/modules/services/postData.js");
/* harmony import */ var _services_closeModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/closeModal */ "./src/js/modules/services/closeModal.js");
...
function forms(state) {
  ...
  phoneInputs.forEach(function (input) {
    input.addEventListener('input', function () {
      Object(_services_inputValidationNumber__WEBPACK_IMPORTED_MODULE_4__["default"])(input);
    });
  });

  function initFormSubmit(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault(); // messageStatus(messages.loading, form, 'status', 'beforeend');
      ...
      Object(_services_postData__WEBPACK_IMPORTED_MODULE_5__["default"])('assets/server.php', formData).then(function (data) {
        console.log(data); // messageStatus(messages.success, form, 'status', 'beforeend');

        messageStatus.innerText = messages.success;
      }).catch(function () {
        messageStatus.innerText = messages.error; // messageStatus(messages.error, form, 'status', 'beforeend');
      }).finally(function () {
        var messageStatus = document.querySelector('.status'),
            allModals = document.querySelectorAll('[data-modal]');
        setTimeout(function () {
          return messageStatus.remove();
        }, 4000);
        setTimeout(function () {
          return allModals.forEach(function (modal) {
            return Object(_services_closeModal__WEBPACK_IMPORTED_MODULE_6__["default"])(modal);
          });
        }, 6000);
...
/* harmony import */ var _services_closeModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/closeModal */ "./src/js/modules/services/closeModal.js");
...
function images() {
  var imagesRow = document.querySelector('.works .row'),
  ...
  function openWindowModal(imgElem) {
    var src = imgElem.parentElement.getAttribute('href');
    imageBig.setAttribute('src', src);
    imgPopup.style.display = 'flex';
    document.body.style.overflow = "hidden";
  }

  imagesRow.addEventListener('click', function (e) {
    e.preventDefault();
    ...
    if (e.target && e.target === imgPopup) {
      Object(_services_closeModal__WEBPACK_IMPORTED_MODULE_4__["default"])(imgPopup);
    }
  });
}
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _services_closeModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/closeModal */ "./src/js/modules/services/closeModal.js");
/* harmony import */ var _services_openModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/openModal */ "./src/js/modules/services/openModal.js");




function modals(state) {
  function bindModal(triggerSelector, windowSelector, closeSelector) {
    var closeByOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var propsValidation = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : [];
    ...
    triggers.forEach(function (trigger) {
      trigger.addEventListener('click', function (e) {
        ...
        if (propsValidation.length > 0) {
          var checkValidation = propsValidation.every(function (item) {
            return state[item];
          });

          if (checkValidation) {
            allModals.forEach(function (modal) {
              return Object(_services_closeModal__WEBPACK_IMPORTED_MODULE_1__["default"])(modal);
            });
            Object(_services_openModal__WEBPACK_IMPORTED_MODULE_2__["default"])(window);
          } else {
            var existentMessageValid = document.querySelector('.messageValid');
    ...
    closeBtn.addEventListener('click', function () {
      ...
      Object(_services_closeModal__WEBPACK_IMPORTED_MODULE_1__["default"])(window);
    });
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false, ['type', 'profile']);
...
/***/ "./src/js/modules/services/closeModal.js":
/*!***********************************************!*\
  !*** ./src/js/modules/services/closeModal.js ***!
  \***********************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/services/inputValidationNumber.js":
/*!**********************************************************!*\
  !*** ./src/js/modules/services/inputValidationNumber.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (inputValidationNumber);

/***/ }),

/***/ "./src/js/modules/services/openModal.js":
/*!**********************************************!*\
  !*** ./src/js/modules/services/openModal.js ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/services/postData.js":
/*!*********************************************!*\
  !*** ./src/js/modules/services/postData.js ***!
  \*********************************************/
/*! exports provided: default */
...
function tabs(tabsBlockSelector, tabSelector, contentSelector, activeClass) {
  var displayStyleContent = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  var tabsBlock = document.querySelector(tabsBlockSelector),
  ...
  function hideTabs() {
    tabs.forEach(function (item) {
      ...
      item.children.forEach(function (child) {
        return child.classList.remove(activeClass);
      });
    });
  ...
  function showCurrentTab() {
    var currentTabIndex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    tabs[currentTabIndex].classList.add(activeClass);
    tabs[currentTabIndex].children.forEach(function (child) {
      return child.focus();
    });
    tabs[currentTabIndex].children.forEach(function (child) {
      return child.classList.add(activeClass);
    });
